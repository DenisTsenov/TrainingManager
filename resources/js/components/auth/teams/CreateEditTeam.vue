<template>
    <div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group text-center" v-if="actionType == 'Create'">
                                <note
                                    text="Please, pay attention to trainer's settlement and sport. Once team is created, you will be able to see only (in edit functionality) trainers and members/users only for trainer's settlement and sport selected in this step."></note>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <note :base-style="noteBaseStyles"
                                  text="If the member/user has no role, he/she will be registered as a competitor"></note>
                            <p class="h3 text-center">Members/Users</p>
                        </div>
                        <div class="card-body scroll-h-400-px">
                            <div class="form-inline" v-if="users !== {}">
                                <team-member-card :members="members"
                                                  :users="users"
                                                  :team="team"
        ...
        <div class="form-group text-center" v-if="actionType == 'Edit'">
            <remove-team-button :team="team" :destroy-route="destroyRoute"></remove-team-button>
        </div>
    </div>
</template>
